              ...
              <div style={{height: '400px'}} className="population-pyramid">
                    ...
                    <div key={index} className="pyramid-row flex items-center mb-2 group">
                      <div className="flex-1 flex justify-end pr-2">
                        <div className="relative">
                          <div 
                            style={{width: `${(group.male / maxValue) * 100}%`, minWidth: '20px'}} 
                      ...
                      <div className="flex-1 flex justify-start pl-2">
                        <div className="relative">
                          <div 
                            style={{width: `${(group.female / maxValue) * 100}%`, minWidth: '20px'}} 
                ...
                <div className="pyramid-footer mt-6 bg-gray-50 rounded-lg p-4">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      <div className="text-2xl font-bold text-blue-600">14,000</div>
                      <div className="text-sm text-gray-600">Total Male</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-gray-800">29,060</div>
                      <div className="text-sm text-gray-600">Total Population</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-pink-600">15,060</div>
